...
@RestController
@RequestMapping(value = "/tipoCarga")
public class TipoCargaController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Criado (Created)", content = {
                    @Content(mediaType = "application/json", schema = @Schema(implementation = TipoCargaDTO.class))}),
    ...
    public ResponseEntity<Object> cadastrar(@RequestBody TipoCargaDTO objeto) throws Exception {
        return tipoCargaService.cadastrar(objeto);
    }
    ...
    public ResponseEntity<Object> listarPorId(@PathVariable Long idObjeto) throws Exception {
        return tipoCargaService.listarPorId(idObjeto);
    }
    ...
    public ResponseEntity<Object> editar(@PathVariable Long idObjeto, @RequestBody TipoCargaDTO objeto) throws Exception {
        return tipoCargaService.editar(idObjeto, objeto);
    }
    ...
    public ResponseEntity<Object> excluir(@PathVariable Long idObjeto) throws Exception {
        return tipoCargaService.excluir(idObjeto);
    }
    ...
    public ResponseEntity<Object> mudarStatus(@PathVariable Long idObjeto) throws Exception {
        return tipoCargaService.mudarStatus(idObjeto);
    }
}
